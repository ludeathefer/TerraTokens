...
return(
    <div className=" h-screen w-screen justify-center flex flex-col items-center " >
        ...
        <div className=" flex flex-row w-[80%] space-x-4 pl-9" >
                ...
                <PopoverContent className=" bg-black text-white  h-full " >
                    ...
                    <div className="flex flex-col justify-center   " >
                        <div className="flex flex-row items-center p-1 " >
                            Min:  
                            <Input placeholder="1000" defaultValue={1000} className="w-10/12 " />
                        </div>
                        <div className="flex flex-row items-center p-1" >
                            Max:
                            <Input placeholder="50000" defaultValue={50000} className="w-10/12" />
                        </div>
                    </div>
                    </div>
                </PopoverContent>
        ...
        <div className="flex flex-col p-5 w-[80%] space-x-4  " >
                ...
                <ScrollArea className=" h-52 w-full rounded-md border ">
                    <div className="flex gap-4 mx-4 mt-2" >
                        {tokensListRecent.map((tokensList, tnt)=>(
                                <div className="flex flex-col h-full w-72 p-5 bg-gray-600  rounded-2xl gap-3 " key={tnt} >
                                   <div className="flex justify-between py-2 bg-[#212121] mb-2 px-2 rounded-xl ">
                                    <Avatar>
                          <AvatarImage src="https://github.com/shadcn.png" />
                          <AvatarFallback>MA</AvatarFallback>
                        </Avatar>
                        <p className="text-3xl font-semibold" >{tokensList.noOfTokens} Tokens</p>
                                   </div>
                                   <p className=" font-semibold text-gray-900  " >{tokensList.area}, {tokensList.city}</p>
