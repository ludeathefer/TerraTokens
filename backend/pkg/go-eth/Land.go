...
// FractionalizeLand is a paid mutator transaction binding the contract method 0xc1f15bfb.
//
// Solidity: function fractionalizeLand(string name, uint256 numberOfFractions, string metadataURI) returns()
func (_Land *LandTransactor) FractionalizeLand(opts *bind.TransactOpts, name string, numberOfFractions *big.Int, metadataURI string) (*types.Transaction, error) {
	return _Land.contract.Transact(opts, "fractionalizeLand", name, numberOfFractions, metadataURI)
}

// FractionalizeLand is a paid mutator transaction binding the contract method 0xc1f15bfb.
//
// Solidity: function fractionalizeLand(string name, uint256 numberOfFractions, string metadataURI) returns()
func (_Land *LandSession) FractionalizeLand(name string, numberOfFractions *big.Int, metadataURI string) (*types.Transaction, error) {
	return _Land.Contract.FractionalizeLand(&_Land.TransactOpts, name, numberOfFractions, metadataURI)
}

// FractionalizeLand is a paid mutator transaction binding the contract method 0xc1f15bfb.
//
// Solidity: function fractionalizeLand(string name, uint256 numberOfFractions, string metadataURI) returns()
func (_Land *LandTransactorSession) FractionalizeLand(name string, numberOfFractions *big.Int, metadataURI string) (*types.Transaction, error) {
	return _Land.Contract.FractionalizeLand(&_Land.TransactOpts, name, numberOfFractions, metadataURI)
}
...
// PurchaseTokens is a paid mutator transaction binding the contract method 0xa14e768a.
//
// Solidity: function purchaseTokens(uint256 landId, (address,uint256,uint256,uint256) order) payable returns()
func (_Land *LandTransactor) PurchaseTokens(opts *bind.TransactOpts, landId *big.Int, order LandSaleOrder) (*types.Transaction, error) {
	return _Land.contract.Transact(opts, "purchaseTokens", landId, order)
}

// PurchaseTokens is a paid mutator transaction binding the contract method 0xa14e768a.
//
// Solidity: function purchaseTokens(uint256 landId, (address,uint256,uint256,uint256) order) payable returns()
func (_Land *LandSession) PurchaseTokens(landId *big.Int, order LandSaleOrder) (*types.Transaction, error) {
	return _Land.Contract.PurchaseTokens(&_Land.TransactOpts, landId, order)
}

// PurchaseTokens is a paid mutator transaction binding the contract method 0xa14e768a.
//
// Solidity: function purchaseTokens(uint256 landId, (address,uint256,uint256,uint256) order) payable returns()
func (_Land *LandTransactorSession) PurchaseTokens(landId *big.Int, order LandSaleOrder) (*types.Transaction, error) {
	return _Land.Contract.PurchaseTokens(&_Land.TransactOpts, landId, order)
}
...
// FilterLandFractionalized is a free log retrieval operation binding the contract event 0xb2732409110a94bc6adffa6e94cb00089777c21ebda678f673a585feca5da6d7.
//
// Solidity: event LandFractionalized(uint256 indexed landId, string name, uint256 numberOfFractions, string metadataURI)
...
// WatchLandFractionalized is a free log subscription operation binding the contract event 0xb2732409110a94bc6adffa6e94cb00089777c21ebda678f673a585feca5da6d7.
//
// Solidity: event LandFractionalized(uint256 indexed landId, string name, uint256 numberOfFractions, string metadataURI)
...
// ParseLandFractionalized is a log parse operation binding the contract event 0xb2732409110a94bc6adffa6e94cb00089777c21ebda678f673a585feca5da6d7.
//
// Solidity: event LandFractionalized(uint256 indexed landId, string name, uint256 numberOfFractions, string metadataURI)
